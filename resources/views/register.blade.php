            ...
            <div class="row form-overflow">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4  pt-xl-0 mt-xl-n5">
                        ...
                        <form id="registrationForm" action="{{ route('register.submit') }}" method="POST" style="width: 23rem;">
                            @csrf
                            ...
                            <p>Want To Go To Login Page? <a href="{{ route('login') }}" class="link-info">Login</a></p>
