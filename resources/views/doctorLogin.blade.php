            ...
            <div class="row form-overflow">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4  pt-xl-0 mt-xl-n5">
                        ...
                        <form id="registrationForm" action="{{ route('doctor.loginCheck') }}" method="POST" style="width: 23rem;">
                            @csrf

                            <h3 class="fw-normal mb-3 pb-3 fw-700" style="letter-spacing: 1px;">Doctor Login</h3>
                            ...
                            <p>Don't have an account? <a href="{{ route('doctor.register') }}" class="link-info">Register here</a></p>
                        </form>
